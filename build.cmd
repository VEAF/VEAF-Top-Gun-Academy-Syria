@echo off
set MISSION_NAME=VEAF-Top-Gun-Academy-Syria
echo.
echo ----------------------------------------
...
@REM rem -- generate the time and weather versions
@REM IF ["%SKIP_WEATHER%"] == [""] GOTO GenerateWeather
@REM GOTO DontGenerateWeather
@REM :GenerateWeather
